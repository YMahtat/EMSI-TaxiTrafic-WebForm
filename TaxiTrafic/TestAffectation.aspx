<%@ Page Title="" Language="C#" MasterPageFile="~/AdministratorMaster.master" AutoEventWireup="true" CodeBehind="TestAffectation.aspx.cs" Inherits="TaxiTrafic.TestAffectation" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="PAGE_CONTENT" runat="server">
    ...
    <asp:Panel ID="Panel3" runat="server" Visible="true">
            <div style="padding-right: 0px; margin-right: 0px;text-align:center" class="cp-booking-outer">
                ...
                <asp:Button  Style="color: midnightblue" class="cp-btn-style1" ID="initAffect" runat="server" Text="INITIALISER AFFECTATION" Width="897px" OnClick="initAffect_Click" Font-Bold="True" Font-Names="Century Gothic" Height="68px"  />
